...
export type FreebuffErrorClass = 'quota_exhausted' | 'rate_limit' | 'ip_cap' | 'auth' | 'permission' | 'banned' | 'country_blocked' | 'session_conflict' | 'model_unavailable' | 'invalid_request' | 'transient' | 'timeout' | 'network' | 'server' | 'unknown';
...
export declare const DEFAULT_FAILOVER_POLICY: FailoverPolicy;
